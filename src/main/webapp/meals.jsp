            ...
            <tbody>
                ...
                <c:forEach var = "meal" items="${mealsTo}">
                    <tr style="${meal.excess ? "color: red;" : "color: green;"}">
                        ...
                        <td>${meal.calories}</td>
                        <td><h4><a href="meals?action=update&id=${meal.id}&description=${meal.description}&dateTime=${meal.dateTime}&calories=${meal.calories}">Update</a></h4></td>
                        <td><h4><a href="meals?action=delete&id=${meal.id}">Delete</a></h4></td>
